{{-- Form Tambah Wisata Desa dengan Map Location --}}
@extends('admin.layout')

@section('title', 'Tambah Wisata Desa Baru')
...
@section('content')
    <h1>Tambah Wisata Desa Baru</h1>
    <form action="{{ route('admin.wisata_desas.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="search-container">
                <input type="text" class="form-control" id="location-search" placeholder="Cari lokasi (cth: Green Canyon atau -6.43,107.38)">
                <button type="button" class="btn btn-info" id="search-btn">Cari</button>
            </div>
            <div id="map"></div>
            <div class="location-info">
                <small class="text-muted">Klik pada peta untuk memilih lokasi wisata atau gunakan fitur pencarian di atas (bisa nama lokasi atau koordinat Lat,Lng). Marker akan menunjukkan lokasi yang dipilih.</small>
...
@section('scripts')
    ...
    <script>
        ...
        function searchLocation() {
            ...
            // Jika bukan koordinat atau koordinat tidak valid, lakukan pencarian nama lokasi melalui Nominatim API
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log("DOMContentLoaded terpicu. Memulai inisialisasi peta.");
            ...
            // Muat koordinat lama jika ada (dari old() input setelah validasi gagal)
            ...
            function initMapDefaultOrGeolocation() {
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        // Hanya tambahkan marker jika belum ada dari old()
                        if (!marker) {
                            marker = L.marker([lat, lng], { draggable: true }).addTo(map);
                            updateLocationInfo(lat, lng);
                            marker.on('dragend', function(e) {
